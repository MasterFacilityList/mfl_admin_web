...
angular.module("mflAppConfig", ["mfl.auth.permissions",
    ...
    .config(["silGridConfigProvider", function(silGridConfig){
        silGridConfig.apiMaps = {
                ...
                jobTitles: ["mfl.setup.jobTitles.wrapper", "jobTitlesApi"],
                faciltyOwnerTypes: ["mfl.setup.facilityOwners.wrapper", "facilityOwnerTypesApi"],
                faciltyOwners: ["mfl.setup.facilityOwners.wrapper", "facilityOwnersApi"],
