...
angular.module("mflAppConfig", ["mfl.auth.permissions",
    ...
    .config(["silGridConfigProvider", function(silGridConfig){
        silGridConfig.apiMaps = {
                ...
                contacts: ["mfl.setup.contacts.wrapper", "contactsApi"],
                jobTitles: ["mfl.setup.facilities.wrapper", "facilityJobTitlesApi"],
                faciltyOwnerTypes: ["mfl.setup.facilities.wrapper", "facilityOwnerTypesApi"],
                faciltyOwners: ["mfl.setup.facilities.wrapper", "facilityOwnersApi"],
                facilityRegulatoryBodies: ["mfl.setup.facilities.wrapper",
                             "facilityRegulatoryBodiesApi"],
                chuStatus: ["mfl.setup.chu.wrapper", "chuStatusApi"],
                chuApprovers: ["mfl.setup.chu.wrapper", "chuApproversApi"],
