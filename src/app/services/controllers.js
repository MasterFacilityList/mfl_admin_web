(function (angular) {
    ...
    .controller("mfl.services.controllers.services",
        ["$scope",  "mfl.services.services.services",
    ...
    .controller("mfl.services.controllers.new_service",
        ["$scope", "mfl.services.services.services", "$state",
    ...
    .controller("mfl.services.controllers.edit_service",
        ["$scope", "$stateParams", "mfl.services.services.services",
    ...
    .controller("mfl.services.controllers.view_service",
        ["$scope", "mfl.services.services.services", "$stateParams",
