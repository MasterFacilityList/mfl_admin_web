(function(describe){
    "use strict";
    describe("dashboard controllers test suite", function(){
        ...
        it("should have `mfl.setup.controller.dashboard` defined",
           function(){
                var ctrl = createController("mfl.setup.controller.dashboard", {});
