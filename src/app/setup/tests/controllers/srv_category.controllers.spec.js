(function () {
    ...
    describe("Test category controllers", function () {
        ...
        beforeEach(function () {
            ...
            module("mfl.setup.categories.controllers");
        ...
        describe("Test category delete controller", function () {
            ...
            it("should delete the category", function () {
                ...
                expect(state.go).toHaveBeenCalledWith("setup.srv_category_list",
                    {},{reload:true});
                scope.cancel();
                expect(state.go).toHaveBeenCalledWith("setup.srv_category_list.category_edit");
                expect(state.go).toHaveBeenCalled();
            });
        });
